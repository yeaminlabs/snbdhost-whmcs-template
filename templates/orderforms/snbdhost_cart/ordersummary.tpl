{if $producttotals}
    ...
    {assign var="cartIndex" value=$smarty.post.i|default:$smarty.get.i|default:$i}
    {if $smarty.session.cart.products.$cartIndex.domain}
    <div class="clearfix" style="margin: 0 0 1rem 0; padding: 0.75rem 1rem; background: #f8fafc; border-radius: 8px; border: 1px dashed #cbd5e1; display: flex; justify-content: space-between; align-items: center;">
        ...
        <span class="pull-right float-right" style="font-weight:700; color:#0f172a; font-size:1rem;">{$smarty.session.cart.products.$cartIndex.domain}</span>
    </div>
    {/if}
