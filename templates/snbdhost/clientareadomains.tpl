...
<div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
    <div>
        <h1 class="dash-headline" style="font-size: 2.25rem; margin-bottom: 0.25rem;">My <span class="dash-headline-accent">Domains.</span></h1>
        <p class="text-secondary small mb-0">Manage, renew, and register your domain names.</p>
    </div>
    <a href="https://snbdhost.com/domain" target="_blank" class="btn btn-brand-clean"><i class="ti ti-plus me-2"></i>Register New Domain</a>
</div>
